...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoFlights = __webpack_require__(206);

	var _NoFlights2 = _interopRequireDefault(_NoFlights);
	      ...
	      return _react2.default.createElement(
	        ...
	        function () {
	          ...
	          if (_this2.props.flights.data.length > 0) {
	            ...
	            return _react2.default.createElement(_NoFlights2.default, null);
	          }
	        }()
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputPlace = __webpack_require__(191);

	var _InputPlace2 = _interopRequireDefault(_InputPlace);

	var _InputDate = __webpack_require__(192);
	...
	var Filter = function (_Component) {
	  ...
	  function Filter() {
	    ...
	    _this.addReturnFlight = _this.addReturnFlight.bind(_this);
	    _this.removeReturnFlight = _this.removeReturnFlight.bind(_this);
	  ...
	  _createClass(Filter, [{
	    key: 'setFilterValue',
	    value: function setFilterValue(name, displayValue, searchValue) {
	    ...
	    key: 'addReturnFlight',
	    value: function addReturnFlight() {
	      this.setState({
	        returnFlight: true
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputPlace = function (_Component) {
	  _inherits(InputPlace, _Component);

	  function InputPlace() {
	    _classCallCheck(this, InputPlace);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InputPlace).call(this));
	  ...
	  _createClass(InputPlace, [{
	    key: 'handleChange',
	    value: function handleChange() {
	      var displayValue = this.refs.inputPlace.value;
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (this.state.value !== nextProps.value) {
	        ...
	        if (nextProps.value !== '') this.loadWhispers(nextProps.value);else this.unloadWhispers();
	      }
	    }
	  }, {
	    key: 'loadWhispers',
	    value: function loadWhispers(term) {
	      var self = this;
	      var query = 'https://api.skypicker.com/places?term=' + term + '&v=2&local';
	      (0, _reqwest2.default)(query, function (resp) {
	        self.setState({
	          whispers: resp
	        });
	    ...
	    key: 'setWhisper',
	    value: function setWhisper(displayValue, searchValue) {
	      var _this2 = this;
	      ...
	      this.setState({
	        ...
	        _this2.props.setValue(_this2.props.name, displayValue, _this2.state.searchValue);
	        _this2.unloadWhispers();
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'col col-xs-12' },
	        _react2.default.createElement('input', { ref: 'inputPlace', onChange: this.handleChange.bind(this, this.state.searchValue), value: this.state.value, type: 'text', name: this.props.name, placeholder: this.props.placeholder, autoComplete: 'off' }),
	        function () {
	          if (_this3.state.whispers.length > 0) return _react2.default.createElement(
	            'ul',
	            { className: 'search_whisperer' },
	            _this3.state.whispers.map(function (whisper) {
	              return _react2.default.createElement(
	                'li',
	                { className: 'whisper', onClick: _this3.setWhisper.bind(_this3, whisper.value, whisper.id) },
	                whisper.value
	              );
	            })
	          );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputDate = function (_Component) {
	  ...
	  function InputDate() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InputDate).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Result = __webpack_require__(194);
	...
	var Results = function (_Component) {
	  ...
	  function Results() {
	    ...
	    _this.hideOthers = _this.hideOthers.bind(_this);
	    _this.hideMe = _this.hideMe.bind(_this);
	    return _this;
	  }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { id: 'results_list' },
	          self.props.flights.slice(0, self.state.limit).map(function (flight) {
	            return _react2.default.createElement(_Result2.default, { hideOthers: _this2.hideOthers, hideMe: self.hideMe, componentKey: flight.id, key: flight.id, data: flight, addInfo: self.state.addInfo == flight.id });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Result = function (_Component) {
		...
		function Result() {
			...
			_this.toggleAddInfo = _this.toggleAddInfo.bind(_this);
			return _this;
		}
		...
		_createClass(Result, [{
			...
			key: 'toggleAddInfo',
			value: function toggleAddInfo() {
				if (!this.state.addInfo) this.props.hideOthers(this.props.componentKey);else this.props.hideMe(this.props.componentKey);
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'li',
					{ onClick: this.toggleAddInfo, className: 'result col col-sm-12 col-md-6 col-lg-6 col-xl-4' },
					_react2.default.createElement(
						'div',
						{ className: 'result_wrapper' },
						_react2.default.createElement(
							'div',
							{ className: 'result_seg clearfix' },
							_react2.default.createElement(
								'div',
								{ className: 'row' },
								_react2.default.createElement(
									'div',
									{ className: 'route_detail col col-xs-8' },
									_react2.default.createElement(
										'span',
										{ className: 'from' },
										result.cityFrom,
								...
								_react2.default.createElement(
									'div',
									{ className: 'route_price col col-xs-2 col-xs-offset-2' },
									_react2.default.createElement(
										'span',
										{ className: 'price' },
										result.conversion.EUR,
										'€'
									)
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'route_date col col-xs-4' },
									_react2.default.createElement(
										'span',
										{ className: 'date' },
								...
								_react2.default.createElement(
									'div',
									{ className: 'route_time col col-xs-4 col-xs-offset-1' },
									_react2.default.createElement(
										'span',
										{ className: 'time' },
								...
								_react2.default.createElement(
									'div',
									{ className: 'route_airline_logo col col-xs-2 col-xs-offset-1' },
									_react2.default.createElement('img', { src: 'https://s3-eu-west-1.amazonaws.com/images.skypicker.com/airlines/32/' + result.route[0].airline + '.png', alt: 'logo', className: 'logo' })
								)
							)
						),
						function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sortbas = function (_Component) {
	  _inherits(Sortbas, _Component);

	  function Sortbas() {
	    _classCallCheck(this, Sortbas);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Sortbas).apply(this, arguments));
	  }
...
/***/ function(module, exports) {
	...
	exports.default = function () {
		var places = arguments.length <= 0 || arguments[0] === undefined ? {
			query: '',
			data: []
		} : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoFlights = function (_Component) {
	  _inherits(NoFlights, _Component);

	  function NoFlights() {
	    _classCallCheck(this, NoFlights);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NoFlights).apply(this, arguments));
	  }

	  _createClass(NoFlights, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "section",
